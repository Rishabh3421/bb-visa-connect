      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {countries.map((country) => (
            <Link key={country.id} to={`/country/${country.id}`} className="block">
              <Card className="group gradient-card shadow-card hover:shadow-floating transition-smooth border-gradient cursor-pointer overflow-hidden h-full">
                ...
                <CardContent className="p-6 flex flex-col justify-between flex-1">
                  ...
                  <Button 
                    className="w-full gradient-primary text-white font-medium group-hover:shadow-soft transition-smooth"
                  >
                    Learn More
